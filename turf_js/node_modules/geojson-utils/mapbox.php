                                        ...
                                        for (var i = 0; i < features.length; i++) {
                                            ...
                                            if (turf.inside(center, poly)) {
                                                ...
                                                for (index=0; index*30 < 360; index++) {
                                                    ...
                                                    var point_intersection = turf.point([intersect.geometry.coordinates[1][0],intersect.geometry.coordinates[1][1]]);
                                                    var dist = turf.distance(center, point_intersection);
                                                    intersection_pts_array.push(point_intersection);
